...
| STT | Nhóm đối tượng | Chức năng |
|:---:|:----------------:|----------|
| 1 | **Quản trị viên** | - Quản lý vận hành ga, tàu, chuyến<br>- Quản lý tài khoản người dùng<br>- Xem báo cáo cuối tháng<br>- Cấp quyền cho các nhóm đối tượng khác |
| 2 | **Quản lý ga** | - Quản lý ga<br> - Quản lý thiết bị vận hành tại ga<br>- Quản lý nhân sự (nhân viên vé, bảo trì)<br>- Theo dõi và cập nhật lịch trình bảo trì<br>- Tổng hợp và gửi báo cáo cho quản trị viên |
| 3 | **Nhân viên vé** | - Mua, in, thay đổi vé tàu<br>- Kiểm tra giao dịch thanh toán<br>- Kiểm tra thông tin hành khách<br>- Xác minh vé thanh toán trực tuyến |
...
----------
![Use Case hệ thống](https://raw.githubusercontent.com/Nghanle05/E-Metro_System_Software_Development_Project/main/M%C3%B4%20h%C3%ACnh%20h%C3%B3a%20ch%E1%BB%A9c%20n%C4%83ng/Use%20Case%20Diagram/METRO_usecase.png)
