...
| 2 | **Quản lý ga** | - Quản lý thiết bị vận hành tại ga<br>- Quản lý nhân sự (nhân viên vé, bảo trì)<br>- Theo dõi và cập nhật lịch trình bảo trì<br>- Tổng hợp và gửi báo cáo cho quản trị viên |
...
| 5 | **Hệ thống tích hợp** | - Hỗ trợ thanh toán qua phần mềm<br>- Xác minh giao dịch mua vé<br>- Gửi thông báo và cảnh báo sự cố<br>- Lưu trữ lịch sử thông báo và giao dịch |
