...
| Nhóm đối tượng | Chức năng |
|----------------|----------|
| **Quản trị viên** | - Quản lý vận hành ga, tàu, chuyến<br>- Quản lý tài khoản người dùng<br>- Xem báo cáo cuối tháng<br>- Cấp quyền cho các nhóm đối tượng khác |
| **Quản lý ga** | - Quản lý thiết bị vận hành tại ga<br>- Quản lý nhân sự (nhân viên vé, bảo trì)<br>- Theo dõi và cập nhật lịch trình bảo trì<br>- Tổng hợp và gửi báo cáo cho quản trị viên |
| **Nhân viên vé** | - Mua, in, thay đổi vé tàu<br>- Kiểm tra giao dịch thanh toán<br>- Kiểm tra thông tin hành khách<br>- Xác minh vé thanh toán trực tuyến |
| **Nhân viên bảo trì** | - Bảo trì thiết bị theo lịch phân công<br>- Báo cáo và cập nhật kết quả công việc lên hệ thống |
| **Hệ thống tích hợp** | - Hỗ trợ thanh toán qua phần mềm<br>- Xác minh giao dịch mua vé<br>- Gửi thông báo và cảnh báo sự cố<br>- Lưu trữ lịch sử thông báo và giao dịch |
